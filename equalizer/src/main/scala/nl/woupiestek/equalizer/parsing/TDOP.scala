...
object TDOP {
  ...
  private final case class Write[+O](o: O) extends TDOP[Any, O]
  ...
  val Void: TDOP[Any, Unit] = Write(())
  def write[I, O](o: O): TDOP[I, O] = Write(o)
  ...
  def zipWith[I, A, B, C](
    ...
    case Write(o) => f.map(g(o, _))
    case zw: ZipWith[I, o, p, A] =>
      val h = (x: p, y: B) => (z: o) => g(zw.combine(z, x), y)
      ZipWith(zw.first, zipWith(zw.second, f, h), c[o, C])
    case _ => ZipWith(fa, f, g)
  }
