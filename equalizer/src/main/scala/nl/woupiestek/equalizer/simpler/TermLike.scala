...
object TermLike {
  ...
  def freeVariables[I]: TermLike[I, Set[I]] =
    new TermLike[I, Set[I]] {
      override def variable(id: I): Set[I] = Set(id)

      override def lambda(id: I, body: Set[I]): Set[I] =
        body - id
  ...
  def size[I]: TermLike[I, Int] = new TermLike[I, Int] {
    ...
    override def operate(operator: Int, operand: Int): Int =
      1 + operand + operator

    override def let(id: I, value: Int, context: Int): Int =
      2 + value + context
